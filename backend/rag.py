...
# --- Initialization ---
# Non-OpenAI providers (Gemini, Ollama, ...) reject tiktoken token-id input and
# base64 vectors, so send raw text and ask for plain floats.
...
async def query_rag(message: str, session_id: str, model_name: str | None = None):
    """
